      ...
      <header className="bg-background border-b border-border py-4 px-4 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto">
          ...
          <nav className="flex items-center justify-center space-x-8">
            <a href="#" className="text-accent font-semibold border-b-2 border-accent pb-2">HOME</a>
            <a href="#" className="text-foreground hover:text-accent transition-colors">SHOP</a>
            <a href="#" className="text-foreground hover:text-accent transition-colors">FAQS</a>
            <a href="#" className="text-foreground hover:text-accent transition-colors">ABOUT US</a>
            <a href="#" className="text-foreground hover:text-accent transition-colors">PRIVACY POLICY</a>
            <a href="#" className="text-foreground hover:text-accent transition-colors">CONTACT US</a>
