            ...
            <div className="flex items-center space-x-2 md:space-x-6">
              ...
              <div className="hidden md:flex items-center space-x-6">
                <div className="text-center">
                  <Button variant="ghost" className="flex flex-col items-center p-2 text-gray-600 hover:text-gray-800">
                ...
                <div className="text-center">
                  <Button variant="ghost" className="flex flex-col items-center p-2 text-gray-600 hover:text-gray-800 relative">
                ...
                <div className="text-center">
                  <div className="flex items-center">
                    ...
                    <span className="text-lg font-bold text-gray-800">${getTotalPrice().toFixed(2)}</span>
                  </div>
                </div>
              </div>

              {/* Mobile Layout - Just Cart */}
              <Link to="/cart" className="md:hidden">
                <Button variant="ghost" className="p-2 text-gray-600 hover:text-gray-800 relative">
            ...
            <div className="md:hidden mt-4">
              <div className="flex rounded-lg overflow-hidden border border-gray-300">
                <Input 
                  ...
                  className="rounded-none border-0 flex-1 text-gray-700"
                />
                <Button className="bg-orange-500 hover:bg-orange-600 rounded-none px-4 text-white border-0">
                  <Search className="h-4 w-4" />
                </Button>
              </div>
            </div>
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden">
              <div className="flex flex-col space-y-2">
                <Link to="/" className="text-white font-semibold hover:text-orange-100 transition-colors text-sm uppercase tracking-wide py-2 px-4 rounded hover:bg-orange-600">
                  HOME
                </Link>
                <Link to="/shop" className="text-white font-semibold hover:text-orange-100 transition-colors text-sm uppercase tracking-wide py-2 px-4 rounded hover:bg-orange-600">
                  SHOP
                </Link>
                <Link to="/faq" className="text-white font-semibold hover:text-orange-100 transition-colors text-sm uppercase tracking-wide py-2 px-4 rounded hover:bg-orange-600">
                  FAQS
                </Link>
                <Link to="/about" className="text-white font-semibold hover:text-orange-100 transition-colors text-sm uppercase tracking-wide py-2 px-4 rounded hover:bg-orange-600">
                  ABOUT US
                </Link>
                <Link to="/privacy-policy" className="text-white font-semibold hover:text-orange-100 transition-colors text-sm uppercase tracking-wide py-2 px-4 rounded hover:bg-orange-600">
                  PRIVACY POLICY
                </Link>
                <Link to="/contact" className="text-white font-semibold hover:text-orange-100 transition-colors text-sm uppercase tracking-wide py-2 px-4 rounded hover:bg-orange-600">
                  CONTACT US
                </Link>
                <Link to="/blog" className="text-white font-semibold hover:text-orange-100 transition-colors text-sm uppercase tracking-wide py-2 px-4 rounded hover:bg-orange-600">
                  BLOG
                </Link>
                
                {/* Mobile User Actions */}
                <div className="border-t border-orange-400 pt-4 mt-4 space-y-2">
                  <Link to="#" className="text-white font-semibold hover:text-orange-100 transition-colors text-sm uppercase tracking-wide py-2 px-4 rounded hover:bg-orange-600 flex items-center">
